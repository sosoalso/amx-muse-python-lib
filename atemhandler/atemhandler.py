...
if __name__ == "__main__":
    ...
    def handle_pgm_switched(input_idx):
        print(f"Program switched to input: {input_idx}")
    def handle_pvw_switched(input_idx):
        print(f"Preview switched to input: {input_idx}")
    switcher.handle_event("pgm_switched", handle_pgm_switched)
    switcher.handle_event("pvw_switched", handle_pvw_switched)